...
//    cerr << "<eM>: edge mapping method (Not supported: this version is for VNE-CBS only. Use default value 0)" << endl;
...
//      SG.printEdgeStatus();
    ...
    fprintf(outputFP, "%4d, %6d, %6d, %d, %d, %10.4lf, %10.4lf, %d, %.4f\n",
              curEvent.index, curEvent.time, VNR[curEvent.index].duration, curEvent.type, requestAccepted, totRev, totCost, cbs.count_num,
